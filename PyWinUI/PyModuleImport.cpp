...
BOOST_PYTHON_MODULE(PyUI)
{
	...
	class_<CWebBrowserUI, bases<CControlUI>, boost::noncopyable>("CWebBrowserUI")
		...
		.def("SetWebBrowserEventHandler", &CWebBrowserUI::SetWebBrowserEventHandler)
		.def("CallJs", &CWebBrowserUI::CallJs)
		;
	class_<CWebBrowserEventHandler, boost::noncopyable>("CWebBrowserEventHandler")
		.def("CallCustomHandle", &CWebBrowserEventHandler::CallCustomHandle)
		;
	...
	class_<PyUIBaseWrap, boost::noncopyable>("PyUIBase")
		...
		.def("OnClose", &PyUIBaseWrap::OnClose, &PyUIBaseWrap::default_OnClose)
