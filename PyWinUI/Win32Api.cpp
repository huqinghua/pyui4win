...
std::string CWin32Api::GetPyUI4WinDirectory()
{
	char szExeFolder[MAX_PATH + 1] = {0};
	::GetModuleFileName(g_hModule, szExeFolder, MAX_PATH);
	::PathRemoveFileSpec(szExeFolder);

	return szExeFolder;
}

std::string CWin32Api::Conver2string(int addr)
{
	::OutputDebugStringA(" CWin32Api::Conver2string");
	::OutputDebugStringA((char*)addr);
	return (char*)addr;
}
...
void CWin32Api::OutputDebugMsg(std::string msg)
{
